...
const GoogleButton: React.FC<GoogleIconProps> = ({ redirectTo, className, ...props }) => {
  ...
  return (
    <button
      {...props}
      className={cn("flex items-center justify-center border rounded-full w-10 h-10 shadow-sm bg-white text-gray-700 hover:bg-gray-50 transition-colors duration-200 font-medium", className)}
